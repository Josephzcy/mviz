#ifndef HAVP_VM_OBJECT_REGISTER_H_
#define HAVP_VM_OBJECT_REGISTER_H_

#include "tda4_vm/havp_vm_defination.h"
...
REGISTER(imu_rtk, minieye::ImuDataList);
...
REGISTER(ap_map_response, minieye::parking::ApMapResponse);
REGISTER(map_engine_response, minieye::parking::MapEngineResponse);
...
REGISTER(post_roadmarks, perception::Roadmarks);
...
REGISTER(hmi_to_soc_havp, minieye::HmiToSoc);
